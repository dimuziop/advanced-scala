...
object MagnetPatterns extends App {
  ...
  implicit class FromResponseFuture(response: Future[P2PResponse]) extends MessageMagnet[Int] {
    override def apply(): Int = {
      // logic for handling a P2PResponse
      println("P2p Response handling future")
      24
    }
  }

  implicit class FromRequestFuture(request: Future[P2PRequest]) extends MessageMagnet[Int] {
    override def apply(): Int = {
      // logic for handling a P2PResponse
      println("P2p Response handling future")
      42
